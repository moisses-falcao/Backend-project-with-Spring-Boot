package br.com.moisses.handlers

import br.com.moisses.exceptions.UnsupportedMathOperationException
import br.com.moisses.models.ExceptionResponse
...
class CustomizeResponseEntityExceptionHandler : ResponseEntityExceptionHandler(){
    ...
    fun handleAllExceptions(e: Exception, requerst: WebRequest) :
            ResponseEntity<ExceptionResponse> {
        val exceptionResponse = ExceptionResponse(
                Date(),
                e.message,
                requerst.getDescription(false)
        )
